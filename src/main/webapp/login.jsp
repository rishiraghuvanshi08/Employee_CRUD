	...
	<div class="container-xxl py-5">
		<div class="container">
			<div class="text-center mx-auto mb-3 wow fadeInUp"
				...
				<h3 class="section-title bg-white text-center text-primary px-3">Enter
					Username and Password to Login</h3>
							...
							<div class="col-md-12">
								<div class="form-floating">
									<input type="text" name="username" class="form-control"
										id="username" placeholder="User Name" required> <label
